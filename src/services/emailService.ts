...
// ================= BASE TEMPLATE =================
export const getBaseTemplate = (content: string, title: string): string => {
...
export const grievanceAcknowledgmentEmail = (data: {
	name: string;
	trackingId: string;
	email: string;
}) => {
    ...
    `;
	return getBaseTemplate(content, "Grievance Acknowledgment");
};

// 2. Grievance Resolved Email
export const grievanceResolvedEmail = (data: {
	name: string;
	trackingId: string;
	resolution: string;
}) => {
    ...
    `;
	return getBaseTemplate(content, "Grievance Resolved");
};

// 3. Contact Form Confirmation Email
export const contactConfirmationEmail = (data: {
	name: string;
	email: string;
	subject: string;
}) => {
    ...
    `;
	return getBaseTemplate(content, "Message Received");
};

// 4. Business Registration Confirmation Email
export const businessRegistrationEmail = (data: {
	name: string;
	businessName: string;
    ...
    `;
	return getBaseTemplate(content, "Registration Received");
};

// 5. Certificate Issuance Email
export const certificateIssuedEmail = (data: {
	name: string;
	businessName: string;
    ...
    `;
	return getBaseTemplate(content, "Certificate Issued");
};

// src/services/emailService.ts - Add these new templates

// Grievance Status Update Email
export const grievanceStatusUpdateEmail = (data: {
	name: string;
	trackingId: string;
	status: string;
	message: string;
    ...
    `;
	return getBaseTemplate(content, "Grievance Status Update");
};

// Grievance Rejected Email
export const grievanceRejectedEmail = (data: {
	name: string;
	trackingId: string;
	reason: string;
}) => {
    ...
    `;
	return getBaseTemplate(content, "Grievance Rejected");
};

// src/services/emailService.ts - Add these new templates

// Business Registration Approved Email
export const businessApprovedEmail = (data: {
	name: string;
	businessName: string;
	registrationNumber: string;
	registrationType: string;
    ...
    `;
	return getBaseTemplate(content, "Registration Approved");
};

// src/services/emailService.ts - Add this new template

// Admin Notification for New Contact Submission
export const contactAdminNotificationEmail = (data: {
	name: string;
	email: string;
	phone: string;
	subject: string;
...
export const courseEnrollmentEmail = (data: {
	name: string;
	courseTitle: string;
	courseSlug: string;
	startDate: string;
    ...
    `;
	return getBaseTemplate(content, "Course Enrollment Confirmation");
};

// Course Completion Email
export const courseCompletionEmail = (data: {
	name: string;
	courseTitle: string;
	certificateId: string;
	certificateUrl: string;
    ...
    `;
	return getBaseTemplate(content, "Course Completed");
};

// src/services/emailService.ts - Add this new template

// Course Progress Update Email
export const courseProgressEmail = (data: {
	name: string;
	courseTitle: string;
	progress: number;
	courseSlug: string;
    ...
    `;
	return getBaseTemplate(content, "Course Progress Update");
};
