...
// Public routes
router.get('/', rateLimiter_1.apiLimiter, newsController_1.getNews);
router.get('/slug/:slug', rateLimiter_1.apiLimiter, newsController_1.getNewsBySlug);
router.get('/:id', rateLimiter_1.apiLimiter, newsController_1.getNews); // Fallback by ID
// Admin routes
